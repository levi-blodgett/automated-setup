...
##	Call bash_prompt only once, then unset it (not needed any more)
##	It will set $PS1 with colors and relative to $NEW_PWD, 
##	which gets updated by $PROMPT_COMMAND on behalf of the terminal
bash_prompt
unset bash_prompt
